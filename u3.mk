...
PRODUCT_COPY_FILES += \
    ...
    device/iuni/u3/rootdir/etc/set_baseband.sh:system/etc/set_baseband.sh \
...
PRODUCT_COPY_FILES += \
    ...
    device/iuni/u3/media_codecs_performance.xml:system/etc/media_codecs_performance.xml
...
# WiFi
PRODUCT_COPY_FILES += \
    device/iuni/u3/wifi/WCNSS_cfg.dat:system/etc/firmware/wlan/prima/WCNSS_cfg.dat \
    device/iuni/u3/wifi/WCNSS_qcom_cfg.ini:system/etc/wifi/WCNSS_qcom_cfg.ini \
    device/iuni/u3/wifi/WCNSS_qcom_wlan_nv.bin:system/etc/firmware/wlan/prima/WCNSS_qcom_wlan_nv.bin
